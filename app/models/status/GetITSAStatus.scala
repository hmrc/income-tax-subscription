...
object GetITSAStatus {
  ...
  implicit val reads: Reads[GetITSAStatus] = __.read[String] flatMapResult {
    case "00" => JsSuccess(NoStatus)
    case "01" => JsSuccess(MTDMandated)
    case "02" => JsSuccess(MTDVoluntary)
    case "03" => JsSuccess(Annual)
    case "04" => JsSuccess(DigitallyExempt)
    case "05" => JsSuccess(Dormant)
    case "99" => JsSuccess(MTDExempt)
